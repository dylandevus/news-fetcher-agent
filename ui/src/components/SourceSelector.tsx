...
const SourceSelector: React.FC<SourceSelectorProps> = ({ onSourcesChange }) => {
  ...
  return (
    <div className="relative">
      ...
      >
        <span>{selectedSources.length ? `${selectedSources.length} sources selected` : "News sources"}</span>
        <svg className="w-5 h-5 ml-2 -mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" style={{ color: "#4b5563" }}>
